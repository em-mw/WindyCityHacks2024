...
class Ui_MainWindow(object):
    ...
    def refresh(self) -> None:
        self.MouseCamButton.clicked.connect(lambda:self.mousecamerson())
        #self.MouseCamButton.clicked.connect()
    def mousecamerson(self):
        if self.MouseCamButton.isChecked():
            self.MouseCamButton.setText("MouseCam is (ON) ✅")
            self.label_2.setText("🟡 Status: Detection:")
        else:
            self.MouseCamButton.setText("MouseCam is (OFF) ❌")
